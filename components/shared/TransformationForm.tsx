...
const TransformationForm = ({ creditBalance, userId, type, action, config = null, data = null }: TransformationFormProps) => {
  ...
  const [isPending, startTransition] = useTransition(); //make a http request and not block the UI
